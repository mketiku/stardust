...
class BookingServiceTest {
    ...
    fun `should prevent booking when employee department does not match desk zone`() {
        ...
        assertThrows(DepartmentMismatchException::class.java) {
            bookingService.reserveDesk(1L, 1L)
        }
    ...
    @Test
    fun `Test 1 - throw DepartmentMismatchException when Marketing employee tries to book Engineering desk`() {
    ...
    @Test
    fun `Test 2 - successfully book floor 4 desk for Engineering employee`() {
